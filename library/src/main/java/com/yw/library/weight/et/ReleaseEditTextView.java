...
public class ReleaseEditTextView extends AppCompatEditText {
    public ReleaseEditTextView(Context context) {
        super(context);
    }

    public ReleaseEditTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ReleaseEditTextView(Context context, AttributeSet attrs, int defStyleAttr) {
